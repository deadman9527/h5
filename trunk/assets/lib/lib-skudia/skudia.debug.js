                        ...
                        if(!(obj_attr==null) && obj_num){
                            if(!lib.login.isLogin()){
                                if(that.data.products.is_sea_label==0){
                                    setTimeout(function(){
                                        location.href = "http://h5.ve.cn/direct-order-confirm.html?cartId="+data.cart_id;
                                    },50)
                                }else{
                                    setTimeout(function(){
                                        location.href="http://h5.ve.cn/direct-order-confirm.html?proType=1&cartId="+data.cart_id; //+ that.cartType;
                                    },50)
                                }
                            }else{
                                if(that.data.products.is_sea_label==0){
									setTimeout(function(){
                                        location.href = "http://h5.ve.cn/order-confirm.html";//+ that.cartType;
                                    },50)
                                }else{
									setTimeout(function(){
                                        location.href = "http://h5.ve.cn/order-confirm.html?proType=1";
                                    },50)
                                }
                            }
                        }
