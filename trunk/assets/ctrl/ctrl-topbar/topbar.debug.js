    ...
    $.extend(TopBar.prototype, {
        ...
        _init: function() {
            ...
            if(this.options.isIndex){
                $("body").prepend('<div class="topbar"><a class="top-back" href="javascript:;" style="background: none;color: #fff;font-size: 12px;padding-left: 10px;width: 100px;"></a><h1><img width="88" height="31" style="vertical-align: middle;" src="data:image/png;base64," /></h1></div>');
            }
            else{
				var href="",home = this.options.topHome ? '<a class="top-home" href="http://h5.ve.cn"></a>' : "";
				if(history.length > 1){
