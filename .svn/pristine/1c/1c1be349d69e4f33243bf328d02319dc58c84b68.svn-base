...
;(function ($) {
    ...
    var main = {
        ...
        getTurnOff:function(){
            var that = this;
            $.getJSON('http://act.quxiu.me/data/switch.json', function(data){
        ...
        renderContent : function(type){
            ...
            lib.api.get({
                ...
                success: function (data) {
                    ...
                    des = des.replace(/src/g, 'class="lazy" src="http://h5.quxiu.me/assets/img/cart_img_black_640x253.png" dataimg');
                    if(type==1){
        ...
        renderSlide: function (data) {
            //var data = [{
            //    targetUrl:"http://h5.quxiu.me/app/app-1120/oversea.html",
            ...
            // $(".swiper-container").append('<div class="timeover"></div>');
