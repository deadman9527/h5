...
;(function ($) {
    ...
    var main = {
        ...
        switch:function(){
            var that = this;
            $.get('http://act.quxiu.me/data/switch.json',function(data){
                that.switch = data;
                ...
                success: function (data) {
                    ...
                    if(data.products || data.sea_products){
                        if(!data.products || data.products.length<1){
                            ...
                            $(".container").removeClass("heiauto");
                            $("#products").html('<div class="cart-outer"><div class="cart-inner" style="width:'+winW*percent+'px;height:'+1.7*winW*percent+'px"><a class="go-index" href="http://h5.quxiu.me"></a></div></div>');

                        }else if(!data.sea_products || data.sea_products.length<1){
                            winW = docEl.getBoundingClientRect().width;
                            $(".container").removeClass("heiauto");
                            $("#sea_products").html('<div class="cart-outer"><div class="cart-inner" style="width:'+winW*percent+'px;height:'+1.7*winW*percent+'px"><a class="go-index" href="http://h5.quxiu.me"></a></div></div>');
                        ...
                        winW = docEl.getBoundingClientRect().width;
                        $(".container").removeClass("heiauto");
                        $("#mainItem").html('<div class="cart-outer"><div class="cart-inner" style="width:'+winW*percent+'px;height:'+1.7*winW*percent+'px"><a class="go-index" href="http://h5.quxiu.me"></a></div></div>');
                    }
                    if(that.choose==2){
                        $("#btn-pro").removeClass("hover");
                        $("#btn-sea").addClass("hover");
