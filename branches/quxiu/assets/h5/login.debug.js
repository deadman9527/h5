    ...
    var main = {
        ...
        addEvents: function () {
            ...
            /*$("#login-sina").on('click',function(){
                $(this).attr('href','https://api.weibo.com/oauth2/authorize?client_id=2441162563&response_type=code&redirect_uri=http://h5.quxiu.me/apilogin-callback.html');
            });*/
        ...
        transmit: function(){
            ...
            if (isOnline) {
                ...
                redirectUrlLink = params['redirectUrl'] ? "http://h5.quxiu.me/getpassword.html?redirectUrl=" + encodeURIComponent(params['redirectUrl']) : "http://h5.quxiu.me/getpassword.html";
                ...
                if(params['redirectUrl'].indexOf("cartfrom")>=0){
                    ...
                    redirectUrlLink2 = params['redirectUrl'] ? "http://h5.quxiu.me/register.html?redirectUrl=order-confirm.html%3FproType%3D" + proType : "http://h5.quxiu.me/register.html";
                }else{
                    redirectUrlLink2 = params['redirectUrl'] ? "http://h5.quxiu.me/register.html?redirectUrl=" + encodeURIComponent(params['redirectUrl']) : "http://h5.quxiu.me/register.html";
                }
            ...
            $("#login-sina").on("click",function(){
                ...
                location.href = "https://api.weibo.com/oauth2/authorize?client_id=2441162563&redirect_uri=http%3A%2F%2Ftest.h5.quxiu.me%2Fthirdlogin%2Fcallback.php&response_type=code" ;
            });
            $("#qq_login_btn").on("click",function(){
                lib.storage.set("CallBackUrl",encodeURIComponent(params['redirectUrl']));
                var url = "http://test.h5.quxiu.me/thirdlogin/qqindex.php";
                location.href = url;
            });
